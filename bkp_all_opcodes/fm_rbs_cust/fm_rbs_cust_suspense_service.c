#ifndef lint
static const char Sccs_id[] = "@(#)%Portal Version: fm_rbs_cust_suspense_service.c :BillingVelocityInt:3:2006-Sep-05 21:55:03 %";
#endif
    ...
    pin_errbuf_t    *ebufp)
{
        ...
        *r_flistpp              = NULL;
         ...
         * Insanity Check
         *******************************************************************/
        if (opcode != PCM_OP_RBS_CUST_SUSPENSE_SERVICE) {
        ...
        *******************************************************************/
        PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,
                "op_rbs_cust_suspense_service input flist", i_flistp);

        /*******************************************************************
         * Call the default implementation
         *******************************************************************/

        fm_rbs_cust_suspense_service(ctxp, i_flistp, &r_flistp, ebufp);
	...
	else
	{
		*r_flistpp = PIN_FLIST_COPY(r_flistp, ebufp);
		PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG, "op_rbs_cust_suspense_service output flist", *r_flistpp);
	}
        ...
        pin_errbuf_t            *ebufp)
{
	...
	char			*pd_type = NULL;
        ...
        PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG, "start fm_rbs_cust_suspense_service input_flist", i_flistp);
	...
	if (PIN_ERRBUF_IS_ERR(ebufp))
       	{
	        ret_flistp = PIN_FLIST_CREATE(ebufp);
                s_fail = 1;
                PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,"fm_rbs_cust_suspense_service error", ebufp);
                ...
                PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG, "error fm_rbs_cust_suspense_service flist", ret_flistp);
		...
		ret_flistp = PIN_FLIST_CREATE(ebufp);
                ...
                PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG, "fm_rbs_cust_suspense_service output flist", ret_flistp);
