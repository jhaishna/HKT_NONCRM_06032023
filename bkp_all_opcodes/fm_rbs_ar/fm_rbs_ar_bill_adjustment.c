#ifndef lint
static const char Sccs_id[] = "@(#)%Portal Version: fm_rbs_ar_bill_adjustment.c:CUPmod7.3PatchInt:1:2006-Dec-01 16:31:18 %";
#endif
...
static void
fm_rbs_bill_adjustment_details(
    pcm_context_t       *ctxp,
    int32           flags,
    pin_flist_t     *i_flistp,
    pin_flist_t     **r_flistpp,
    ...
    pin_errbuf_t        *ebufp)
{
    ...
    *r_flistpp      = NULL;
    ...
    if (opcode != RBS_OP_AR_BILL_ADJUSTMENT) {
        pin_set_err(ebufp, PIN_ERRLOC_FM,
            PIN_ERRCLASS_SYSTEM_DETERMINATE,
            PIN_ERR_BAD_OPCODE, 0, 0, opcode);
        PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,
            "op_ar_bill_adjustment error",
            ebufp);
        return;
    }

    PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG, "op_ar_bill_adjustment Input Flist:", i_flistp);

    //Check if adjustment amount is greater than 12340 = $123.40
     billinfo_obj = PIN_FLIST_FLD_GET(i_flistp,PIN_FLD_BILLINFO_OBJ,0,ebufp);
        if ( PIN_POID_IS_NULL(billinfo_obj))
{
    PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,"fm_rbs_ar_adjustment_details Validation : Adjustment more than 12340 = $123.40 not allowed", ebufp);
                ...
                *r_flistpp = PIN_FLIST_CREATE(ebufp);
                ...
                PIN_FLIST_FLD_SET(*r_flistpp, PIN_FLD_ERROR_CODE, "53087", ebufp);
                PIN_FLIST_FLD_SET(*r_flistpp, PIN_FLD_ERROR_DESCR,
                                                "Billinfo obj should not null", ebufp);
    ...
    {
                PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,"op_ar_bill_adjustment Validation : Adjustment more than 12340 = $123.40 not allowed", ebufp);
                PIN_ERRBUF_RESET(ebufp);
                status = 1;
                PIN_ERR_LOG_MSG(PIN_ERR_LEVEL_ERROR, "op_ar_bill_adjustment error");
                *r_flistpp = PIN_FLIST_CREATE(ebufp);
                PIN_FLIST_FLD_SET(*r_flistpp, PIN_FLD_POID,
                PIN_FLIST_FLD_GET(i_flistp, PIN_FLD_POID, 1, ebufp ), ebufp);
    ...
    fm_rbs_bill_adjustment_details(ctxp, flags, i_flistp, r_flistpp, ebufp);

    if (PIN_ERRBUF_IS_ERR(ebufp))
    {
        PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,"op_ar_bill_adjustment error", ebufp);
        PIN_ERRBUF_RESET(ebufp);
        /*status = 1;
        PIN_ERR_LOG_MSG(PIN_ERR_LEVEL_ERROR, "fm_rbs_bill_adjustment_details error");
        *r_flistpp = PIN_FLIST_CREATE(ebufp);
        PIN_FLIST_FLD_SET(*r_flistpp, PIN_FLD_POID,
        PIN_FLIST_FLD_GET(i_flistp, PIN_FLD_POID, 1, ebufp ), ebufp);
        PIN_FLIST_FLD_SET(*r_flistpp, PIN_FLD_ERROR_CODE, "53080", ebufp);
        PIN_FLIST_FLD_SET(*r_flistpp, PIN_FLD_ERROR_DESCR,
                        "fm_rbs_bill_adjustment_details error", ebufp);
        PIN_FLIST_FLD_SET(*r_flistpp, PIN_FLD_STATUS, &status, ebufp);*/
    }
    else
    {
        PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG,  "op_ar_bill_adjustment output flist", *r_flistpp);
    }
    ...
    pin_errbuf_t        *ebufp)
{
        ...
        int32           status= 0;
         ...
         PIN_ERR_LOG_FLIST(PIN_ERR_LEVEL_DEBUG, "start fm_rbs_bill_adjustment_details Input Flist1:", i_flistp);
        ...
        PIN_FLIST_FLD_COPY(i_flistp, PIN_FLD_BILLINFO_OBJ, d_iflistp, PIN_FLD_BILLINFO_OBJ, ebufp);
	...
	PIN_ERR_LOG_FLIST(3, "fm_rbs_bill_adjustment_details output flist:", *r_flistp);
        return;
}
