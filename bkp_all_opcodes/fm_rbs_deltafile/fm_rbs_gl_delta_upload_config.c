...
#ifdef MSDOS
__declspec(dllexport) void * fm_rbs_gl_delta_upload_config();
#endif
...
struct cm_fm_config fm_rbs_gl_delta_upload_config[] = {
	/* opcode as a u_int, function name (as a string) */
	{ RBS_OP_LOAD_GLID, "op_rbs_gl_delta_upload" },
...
#ifdef MSDOS
void *
fm_rbs_gl_delta_upload_config_func()
{
  return ((void *) (fm_rbs_gl_delta_upload_config));
}
#endif
